...
IS_DB_BACKUP="Y"
MIGRATION_DOWNLOAD="$CHUBOE_PROP_JENKINS_AUTHCOMMAND $CHUBOE_PROP_JENKINS_URL/job/$JENKINSPROJECT/${CHUBOE_PROP_JENKINS_BUILD_NUMBER}ws/migration/*zip*/migration.zip"
P2="$CHUBOE_PROP_JENKINS_URL/job/$JENKINSPROJECT/${CHUBOE_PROP_JENKINS_BUILD_NUMBER}ws/buckminster.output/org.adempiere.server_"$IDEMPIERE_VERSION".0-eclipse.feature/site.p2/*zip*/site.p2.zip"
