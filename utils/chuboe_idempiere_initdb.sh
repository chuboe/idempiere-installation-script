...
echo ""
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME_SU -c "$CHUBOE_SQL_CREATE_ROLE_SU"
echo HERE: The following line will fail on AWS RDS. You can ignore if you are using RDS.
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME_SU -c "$CHUBOE_SQL_ALTER_ROLE_SU"
echo HERE: The following line is for AWS RDS. You can ignore if you are not using RDS.
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME_SU -c "$CHUBOE_SQL_ALTER_ROLE_SU_RDS"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME_SU -c "$CHUBOE_SQL_GRANT_MASTER"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME_SU -c "$CHUBOE_SQL_CREATE_DB"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME -d $CHUBOE_PROP_DB_NAME -c "$CHUBOE_SQL_CREATE_SCHEMA"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME -d $CHUBOE_PROP_DB_NAME -c "$CHUBOE_SQL_CREATE_EXTENSION_UUID"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME -d $CHUBOE_PROP_DB_NAME -c "$CHUBOE_SQL_SET_SEARCH_PATH"
sudo -u $IDEMPIEREUSER psql -h $CHUBOE_PROP_DB_HOST -p $CHUBOE_PROP_DB_PORT -U $CHUBOE_PROP_DB_USERNAME -d $CHUBOE_PROP_DB_NAME -f Adempiere_pg.dmp
